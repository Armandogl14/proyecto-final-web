...
public class UrlServiceImpl extends UrlServiceGrpc.UrlServiceImplBase {
    ...
    @Override
    public void getUserUrls(UrlServiceOuterClass.UserRequest request, StreamObserver<UrlServiceOuterClass.UrlList> responseObserver) {
    ...
    @Override
    public void getAccessRecords(UrlServiceOuterClass.AccessRecordRequest request, StreamObserver<UrlServiceOuterClass.AccessRecordList> responseObserver) {
        ...
        UrlServiceOuterClass.AccessRecordList.Builder accessRecordListBuilder = UrlServiceOuterClass.AccessRecordList.newBuilder();
